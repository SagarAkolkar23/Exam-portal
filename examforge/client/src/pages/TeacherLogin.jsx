...
function TeacherLogin() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f9fa] px-6">
      ...
      {/* Bottom Link */}
      <div className="mt-8">
        <Link to="/student/login" className="text-sm font-semibold text-ink-dim hover:text-ink">
          Student? Login here <span aria-hidden="true">&rarr;</span>
        </Link>
      </div>
      ...
      <div className="mt-16 text-center">
        ...
        <p className="text-xs text-slate-400 mt-1">Secure educator portal for academic assessment.</p>
      </div>
